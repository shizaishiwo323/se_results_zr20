...
class SEConfig:
    ...
    offset_D: float = 45.0e-3           # m, finite offset receiver line
...
def synthesize_waveforms_reduced(row: pd.Series, cfg: SEConfig,
    ...
    # Liu et al. finite-offset VSEP electric-dipole approximation:
    # potential u ~ cos(theta)/r^2, with r=sqrt(D^2+z^2) and cos(theta)=z/r.
    # For D=0 this reduces to +/-1/z^2 away from the interface.
    ...
    U = cfg.source_pressure_amp * amp_scale * geom_signed[:, None] * wave[None, :]
    return z, t, U
